	...
	<div id="content">
		...
		<?php do_atomic( 'open_content' ); // ascetica_open_content ?>
			...
			<div id="post-0" class="<?php hybrid_entry_class(); ?>">
				...
				<h1 class="error-404-title entry-title"><?php _e( 'Not Found', 'ascetica' ); ?></h1>

				<div class="entry-content">

					<p>
					<?php printf( __( 'You tried going to %1$s, and it doesn\'t exist. All is not lost! You can search for what you\'re looking for.', 'ascetica' ), '<code>' . home_url( esc_url( $_SERVER['REQUEST_URI'] ) ) . '</code>' ); ?>
					</p>
